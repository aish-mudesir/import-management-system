...
<html>
<head>
	<title>welcome to Agmas Medical company import mangments system</title>

<!--for color pending and deliverd control-->
...
<div class="portlet">
			...
			<table cellpadding="1" cellspacing="1" id="resultTable">
				...
				<?php
					...
					$result = mysql_query("SELECT * FROM process where user = '3' ORDER BY process_id DESC");
