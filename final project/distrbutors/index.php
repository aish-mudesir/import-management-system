	...
	<div id="wrapper">
		...
		<!---start navbar-->link">Message</a>
			...
			<div id="navbar">
			    ...
			    <a href="index.php" title="Product" class="link">order</a>
				<a href="../dis_message.php" title="Message" class="link">Message</a>
				<a href="login1.php" title="Message" class="link">payment</a>
...
<div id="productlist">
			...
			<?php
			require "connect.php";
			$result = mysql_query("SELECT * FROM product where user = '1'");
			while($row=mysql_fetch_assoc($result))
			{
				...
				" width="109" height="109" class="pngfix" title="Name: '.$row['name'].' | Price: ₦'.$row['price'].' | Description: '.$row['description'].'| states: '.$row['states'].'"/></a>';
			}
