...
{
	$res=mysql_query("SELECT * FROM suppliers WHERE supplier_id=".$_GET['edt_id']);
...
<form class="form-horizontal" method="post" enctype="multipart/form-data" action="fun_suppliers.php?edt_id=<?php echo $_GET['edt_id'] ?>">
