...
<form action="addexecs.php" method="post" enctype="multipart/form-data" name="addroom" onsubmit="return validateForm()">
 Name<br />
...
<select name="productStatus" required maxlength="5">
