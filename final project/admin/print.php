...
<img src="src/p18.jpg" width="100" height="100" style="float:left;"><strong>Agmas medical company</strong><br>Addis Ababa city <br>Email Us: info(at)agmasmedical.com<br>Contact: <a href="#">+251 111 553827 </a> 
<br><br><br><br>
<?php
include('connect.php');
		$id=$_GET['id'];
