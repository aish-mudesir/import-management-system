...
while($row2 = mysql_fetch_array($result2))
	...
	echo '<img src="img/products/'.$row2['img'].'" alt="Wall-E" title="'.$name.' | Price ₦'.$price.'" /><br>';
...
<form NAME = "frmOne" action="initiateorder.php" method="post" enctype="multipart/form-data">
	...
	<input type="text" name="select2" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" style="width:60px;" value="1"/> 
   ...
   ?>
	...
	<br>
	<input type="submit" value="Place Order" style="padding:10px; border-radius:15px; background-color:green; border:none; color:#ffffff; font-weight:bold; border: 1px solid #000000"/>
</form>
</html>