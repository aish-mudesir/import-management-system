...
<title>Biftu Adugna Business S.C</title>
...
if($rrrrr==2){
echo ' Inside Ethiopia';
}
if($rrrrr==3){
echo ' Outside Ethiopia';
}
?>" />
...
Inside Ethiopia: 24hrs [Working Days]<br>
Outside Ethiopia: 4 - 5 working days<br>
</p>
...
<select name="user" required maxlength="5">
               <option ></option>
                  <option value='3'>Distrbutors</option>
                </select> <br />
