...
<body>
	...
	<div id="wrapper">
		...
		<!---start navbar-->link">Message</a>
				<a href="personnel.php" title="PERSONNEL" class="link">User</a>
			<div id="navbar">
			    <a href="sh.php" title="PRODUCTS" class="link">Profile</a>
			     <a href="store/generatetrans.php" title="PRODUCTS" class="link">Product</a>
				<a href="products.php" title="PRODUCTS" class="link">Order</a>
				<a href="message.php" title="Customers" class="link">Message</a>
		...
		<div id="orderlist">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				...
				<option value="2">Shipping Inside Enugu Sta.</option>
				<option value="3">Shipping Outside Enugu Sta.</option>
				</select></td>
			  </tr>
			  <tr style="">
