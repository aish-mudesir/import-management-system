    	...
    	<form class="form-horizontal" id="submitProductForm" action="createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	         ...
	         <div class="form-group">
	        	<label for="productName" class="col-sm-3 control-label">Uploader: </label>
	        	<label class="col-sm-1 control-label">: </label>
	         ...
	         <div class="form-group">
	        	<label for="productName" class="col-sm-3 control-label"> Description: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="productName" placeholder="desc" name="desc" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	  
	        <div class="form-group">
